...
- Removed `sharedVpc.hostProjectId` field - host project enablement now always uses the current project for consistency with chart's per-project deployment model
